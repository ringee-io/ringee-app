...
function CompanyActivity({
  ...
  if (phones.length === 0) {
    return (
      <Section title="Ringee">
        <Typography.Body>
          No phone numbers found for team members.
        </Typography.Body>
      </Section>
    );
  }
  ...
  return (
    <>
      <Section title="Ringee">
        ...
        <Typography.Body>
          {phones.length} phone number(s) on record
        </Typography.Body>
      </Section>
          ...
          <DialogList.Item
            ...
            onTrigger={() => {
              showDialog({
                ...
                Dialog: () => (
                  <CallDialog object={object} recordId={recordId} />
                ),
              });
            }}
            actionLabel="Call"
...
export const ringeeActivityWidget: App.Record.Widget = {
  ...
  Widget: ({ recordId, object }) => (
    <RingeeActivityWidget recordId={recordId} object={object} />
  ),
