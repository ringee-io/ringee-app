      ...
      <div className="flex items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-xs text-muted-foreground max-w-2xl">
            ...
            Your system sends contacts and companies to Ringee; Ringee returns calls, outcomes,
            notes, callbacks, meetings, and recordings.
          </p>
        </div>
  ...
  return (
    <div className="flex flex-col items-center gap-3 rounded-xl border border-dashed bg-muted/20 px-6 py-12 text-center">
      ...
      <p className="max-w-sm text-xs text-muted-foreground">
        Create one to expose an API Key, configure outbound webhooks, and start exchanging events.
      </p>
