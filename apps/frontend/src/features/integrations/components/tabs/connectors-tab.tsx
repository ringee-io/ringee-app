    ...
    <div className="flex flex-col gap-6">
      <header className="flex flex-col gap-1">
        ...
        <p className="text-xs text-muted-foreground max-w-2xl">
          ...
          Ringee account. Connectors expose your Ringee data and actions
          (calls, contacts, callbacks, meetings) through a standardized
          protocol so any compatible client can use them.
        </p>
      </header>
  ...
  return (
    <Alert>
      ...
      <AlertDescription className="text-xs">
        Anyone with this URL can read and act on your Ringee data via MCP.
        Only share it with trusted AI clients. If it leaks, contact support to
        rotate your account.
      </AlertDescription>
    </Alert>
  );
