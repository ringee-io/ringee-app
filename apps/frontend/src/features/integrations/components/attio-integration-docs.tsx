...
function Nav() {
  return (
    <nav className='bg-background/80 sticky top-0 z-50 border-b backdrop-blur-lg'>
...
function HeroSection() {
  return (
    <section className='relative overflow-hidden border-b'>
      ...
      <div className='relative mx-auto max-w-screen-xl px-6 pt-20 pb-20 md:pt-28 md:pb-28'>
        <div className='mx-auto max-w-3xl text-center'>
          <div className='mb-6 flex items-center justify-center gap-3'>
            <div className='bg-background flex h-12 w-12 items-center justify-center rounded-xl border p-2 shadow-sm'>
              <Image
                src='/android-chrome-192x192.png'
                alt='Ringee'
                width={32}
          ...
          <p className='text-muted-foreground mx-auto mt-6 max-w-2xl text-lg'>
            ...
            Call context flows in, call activity flows back. No tab-switching,
...
function FeaturesGrid() {
  ...
  return (
    <section className='bg-muted/30 border-b py-20 md:py-28'>
      <div className='mx-auto max-w-screen-xl px-6'>
        ...
        <div className='grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3'>
          {features.map((feature) => (
            <div
              key={feature.title}
              className='bg-card hover:border-foreground/20 flex flex-col rounded-xl border p-6 transition-colors'
            >
        ...
        <div className='mx-auto max-w-2xl'>
          {steps.map((item, i) => (
            <div key={item.step} className='relative flex gap-6 pb-10'>
              {i < steps.length - 1 && (
                <div className='bg-border absolute top-12 left-5 h-[calc(100%-48px)] w-px' />
              )}
              <div className='bg-card flex h-10 w-10 shrink-0 items-center justify-center rounded-full border text-xs font-bold'>
                {item.step}
              </div>
      ...
      <div className='mx-auto max-w-screen-xl px-6'>
        ...
        <div className='mx-auto grid max-w-4xl grid-cols-1 gap-5 md:grid-cols-2'>
          {surfaces.map((surface) => (
            ...
            >
              <div className='bg-muted/50 flex aspect-[16/9] items-center justify-center border-b'>
        ...
        <div className='mx-auto max-w-3xl'>
          ...
          <div className='mt-10 space-y-3'>
            {requirements.map((req, i) => (
              ...
              >
                <div className='bg-muted flex h-7 w-7 shrink-0 items-center justify-center rounded-md text-xs font-bold'>
                  {i + 1}
                </div>
                <div>
...
function CTASection() {
  return (
    <section className='py-20 md:py-28'>
      <div className='mx-auto max-w-screen-xl px-6'>
        <div className='bg-card mx-auto max-w-2xl rounded-2xl border p-10 text-center md:p-16'>
          <div className='mb-6 flex items-center justify-center gap-3'>
            <div className='bg-background flex h-10 w-10 items-center justify-center rounded-lg border p-1.5 shadow-sm'>
              <Image
                src='/android-chrome-192x192.png'
                alt='Ringee'
                width={28}
            ...
            <div className='bg-background flex h-10 w-10 items-center justify-center rounded-lg border p-2 shadow-sm'>
              <Image
                src='/companies/attio.svg'
                alt='Attio'
                width={24}
...
function ScreenshotPlaceholder({ label }: { label: string }) {
  return (
    <div className='bg-muted/50 mt-4 flex aspect-[16/9] items-center justify-center rounded-lg border'>
      <div className='text-muted-foreground flex flex-col items-center gap-2'>
