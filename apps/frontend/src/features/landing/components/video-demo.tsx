...
const VideoDemo = () => {
  const t = useTranslations('marketing.videoDemo');
  return (
      ...
      <div className='mt-10 flex items-center justify-center gap-6'>
        ...
        <div className='hidden flex-col gap-6 lg:flex'>
          <FeatureCard
            ...
            title={t('cards.quickSetup.title')}
            description={t('cards.quickSetup.description')}
          />
          <FeatureCard
            icon={<IconMicrophone className='h-6 w-6 text-purple-500' />}
            title={t('cards.recordCalls.title')}
            description={t('cards.recordCalls.description')}
          />
        </div>
        ...
        <div className='hidden flex-col gap-6 lg:flex'>
          <FeatureCard
            ...
            title={t('cards.countries.title')}
            description={t('cards.countries.description')}
          />
          <FeatureCard
            icon={<span className='text-xl'>💰</span>}
            title={t('cards.cheaper.title')}
            description={t('cards.cheaper.description')}
          />
        </div>
      </div>
    </section>
