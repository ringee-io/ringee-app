  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className={`mx-auto max-w-screen-lg ${embedded ? '' : 'mt-12'}`}
      >
      ...
      {/* Dialer modes + supporting features — skipped when embedded, since the
          marketing detail page already covers this ground in its own sections. */}
      {!embedded && (
        <>
          {/* Dialer modes */}
          <motion.div
