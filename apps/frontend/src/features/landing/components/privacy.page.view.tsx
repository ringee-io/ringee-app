...
export default function PrivacyPageView() {
  return (
    <section className='text-muted-foreground mx-auto max-w-4xl px-6 py-16 text-base leading-relaxed'>
      ...
      <p className='mb-6'>
        Ringee.io (“Ringee”, “we”, “our”, “us”) provides voice calling services
        — through both our web app (browser-based calling) and the Ringee mobile
        app for iOS — that let you make and receive calls, rent numbers, and
        manage credits. This Privacy Policy explains what information we
        collect, how we use it, and how we protect it. By using our service, you
      ...
      <ul className='mb-6 list-disc space-y-2 pl-6'>
        ...
        <li>
          <strong>Phone numbers:</strong> numbers you rent or verify for caller
          ID and inbound routing.
        </li>
        <li>
        ...
        <li>
          ...
          VoIP calls. We do not access your microphone in the background or when
      ...
      <p className='mb-6'>
        The Ringee mobile app does not process any payments or in-app purchases.
        All billing happens on our website — see “Billing &amp; Plans” below.
      </p>
      ...
      <p className='mb-3'>
        We share information only when it’s required for the service to work or
        by law:
      </p>
      <ul className='mb-6 list-disc space-y-2 pl-6'>
        <li>
        ...
        <li>
          <strong>Legal obligations:</strong> we may provide limited account or
          call data when required by a lawful request.
        </li>
      </ul>
      ...
      <p className='mb-3'>
        This data allows us to ensure accurate billing, detect abuse, and comply
        with telecommunications laws. Call recordings (if enabled) are stored
        encrypted and can be deleted from your dashboard.
      </p>
      <p className='mb-6'>
      ...
      <ul className='mb-6 list-disc space-y-2 pl-6'>
        ...
        <li>
          <strong>Correction:</strong> update account info such as your email or
          verified numbers.
        </li>
        <li>
      ...
      <ul className='mb-6 list-disc space-y-2 pl-6'>
        ...
        <li>
          Internal access is strictly limited and regularly audited for safety.
        </li>
      </ul>
      <p className='mb-6'>
        While no system is completely immune to risk, we continuously update our
      ...
      <p className='mb-6'>
        ...
        available within the Ringee mobile app. Your call and payment history is
        retained so you can view invoices and credit usage at any time.
      </p>
      ...
      <p className='mb-6'>
        We may update this Privacy Policy if our practices or legal obligations
        change. The latest version will always be available on this page, and
        significant updates will be announced via email or in-app notification.
      </p>
