          ...
          {orientation === 'horizontal' ? (
            <>
              ...
              <NavigationMenuContent>
                <ul className='grid w-[280px] gap-3 p-4 sm:w-[400px] md:w-[500px] md:grid-cols-2 lg:w-[600px]'>
                  ...
                  <ListItem
                    href='#live-dialer'
                    title={t('navItems.liveDialer')}
                  >
                    {t('navDescriptions.liveDialer')}
                  </ListItem>
                  ...
                  <ListItem href='#agentic' title={t('navItems.agentic')}>
                    {t('navDescriptions.agentic')}
                  </ListItem>
            ...
            <div className='mt-2 flex w-full flex-col gap-2'>
              ...
              <div className='border-border/40 mt-1 ml-2 flex flex-col gap-2 border-l pl-4'>
                ...
                <Link href='#agentic' className='py-1 text-base font-medium'>
                  {t('navItems.agentic')}
                </Link>
