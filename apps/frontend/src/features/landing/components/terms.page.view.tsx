  ...
  return (
    <section className='text-muted-foreground mx-auto max-w-4xl px-6 py-16 text-base leading-relaxed'>
      ...
      <ul className='mb-6 list-disc space-y-2 pl-6'>
        ...
        <li>Any activity that violates local or international telecom laws</li>
      </ul>
      <p className='mb-6'>
        Any violation may lead to immediate account suspension, termination, and
        permanent loss of credits.
      </p>
      ...
      <p className='mb-3'>
        Ringee.io operates on a pay-as-you-go model. Calls are charged based on
        our published rates, which may vary by destination and carrier fees.
        Credits must be added in advance to make calls.
      </p>
      <p className='mb-6'>
        Rates are subject to change at any time, and updates will be reflected
        in your dashboard. Unused credits are non-refundable unless required by
        law.
      </p>
      ...
      <p className='mb-3'>
        We want you to be satisfied with our service. If you experience issues,
        please contact our support team within 14 days of your purchase.
      </p>
      <ul className='mb-6 list-disc space-y-2 pl-6'>
        ...
        <li>
          We may offer replacement credits for failed or incomplete calls caused
          by system errors.
        </li>
      </ul>
      <p className='mb-6'>
      ...
      <p className='mb-6'>
        ...
        violate these Terms, abuse the service, or pose a security or compliance
        risk. Termination may result in loss of access to your account, numbers,
      ...
      <p className='mb-6'>
        To the fullest extent permitted by law, Ringee.io and its affiliates are
      ...
      <p className='mb-6'>
        If you have questions about these Terms or the operation of our service,
        please contact:
      </p>
      <p className='mb-6'>
        Email:{' '}
