      ...
      <div className='mx-auto w-full max-w-6xl px-4 pb-14 sm:px-4 lg:px-6'>
        {showToc ? (
          <div className='min-w-0 lg:grid lg:grid-cols-[16rem_minmax(0,1fr)] lg:items-start lg:gap-8 xl:grid-cols-[17rem_minmax(0,1fr)] xl:gap-10'>
            <aside data-toc-exclude className='hidden lg:block lg:sticky lg:top-[6.25rem] lg:self-start lg:pt-8'>
              <div className='border-border/70 bg-background/80 max-h-[calc(100dvh-7rem)] overflow-y-auto rounded-2xl border px-4 py-5 shadow-[0_18px_45px_-30px_rgba(0,0,0,0.55)] backdrop-blur supports-[backdrop-filter]:bg-background/70'>
                <PageToc />
              </div>
            </aside>
