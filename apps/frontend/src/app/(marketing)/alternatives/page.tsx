...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    'Compare Ringee’s human and AI calling infrastructure to Aircall, JustCall, Kixie, and Orum. Flat pricing, pay-as-you-go usage, open source, and self-hostable.',
  path: '/alternatives'
});
