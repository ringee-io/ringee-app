...
import type { DashboardLayout, DashboardWidget } from "@ringee/database";
...
export const DEFAULT_DASHBOARD_WIDGETS: UpsertWidgetInput[] = [
  ...
  },
  {
    ...
    title: "Upcoming Meetings & Callbacks",
    x: 6,
    y: 14,
    w: 6,
    h: 6,
...
export class DashboardLayoutService {
  ...
  async assertOwnsLayout(
    ...
    const sameOrg = layout.organizationId === (ctx.organizationId ?? null);
    if (!sameUser || !sameOrg) {
