...
export class CrmError extends Error {
  ...
  static fromHttp(
    ...
    if (status === 403)
      return new CrmError("AUTH_REVOKED", false, "forbidden", undefined, body);
    if (status === 404)
      return new CrmError("NOT_FOUND", false, "not found", undefined, body);
    if (status === 409)
      return new CrmError("CONFLICT", false, "conflict", undefined, body);
